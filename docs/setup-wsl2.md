...
- **Phone on same LAN:** Use the Windows host IP (not WSL2’s) and the port (e.g. `8765`). Ensure the host is bound to `0.0.0.0` and that Windows Firewall allows the port.
